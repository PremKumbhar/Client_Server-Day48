...
const createInnerHtml = () => { 
    ...
    innerHtml = `${innerHtml}
     <tr>
      ...
      <td>
         <img name="${empPayrollData._id}" onclick="remove(this)" alt="delete"src="delete-black-18dp.svg">
         <img name="${empPayrollData._id}" alt="edit" onclick="update(this)"src="create-black-18dp.svg">
      </td>    
    </tr>
    `;
    }
